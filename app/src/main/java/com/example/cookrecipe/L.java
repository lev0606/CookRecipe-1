...
public class L {
    ...
    private static String TAG = "lil_";
    ...
    private static final String LOG_TAG_STACK_TRACE_PREFIX = TAG + "trace_";
    private static final String LOG_TAG_UNKNOWN = TAG + L.class.getSimpleName();
